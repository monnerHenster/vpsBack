...
head = "{ \n\t\"file\":\"http://tk4.iioo.pub/Downloads/mp4/"
videoList = open("/home/videoListPrivate.txt","r")
videoList2json = videoList.readlines()
videoList2 = open("/home/videoListPrivate.json","w")
videoList2.write("[")
